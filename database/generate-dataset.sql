-- Recreates a deterministic dataset. Set @dataset_size before running this file.
SET @dataset_size = COALESCE(@dataset_size, 100000);
...
WHERE sequence_number <= @dataset_size;
