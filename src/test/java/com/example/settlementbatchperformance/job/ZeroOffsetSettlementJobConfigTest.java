...
@SpringBootTest
@ActiveProfiles("test")
class ZeroOffsetSettlementJobConfigTest {

    private final JobOperator jobOperator;
    private final Job zeroOffsetSettlementJob;
    private final JdbcTemplate jdbcTemplate;

    @Autowired
    ZeroOffsetSettlementJobConfigTest(
            JobOperator jobOperator,
            @Qualifier(ZeroOffsetSettlementJobConfig.JOB_NAME) Job zeroOffsetSettlementJob,
            JdbcTemplate jdbcTemplate) {
        this.jobOperator = jobOperator;
        this.zeroOffsetSettlementJob = zeroOffsetSettlementJob;
    ...
    @Test
    void processesEverySourceSettlementAcrossMultiplePages() throws Exception {
        insertSettlements(ZeroOffsetSettlementJobConfig.PAGE_SIZE + 7);
